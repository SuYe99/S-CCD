# this script show how to run SCCD from a csv file that store time series information
import pysccd
import numpy as np
import os
import pandas as pd
...
mode = 4
in_path = '/Users/coloury/Dropbox/Documents/QTProjects/S-CCD/test/spectral_336_3980_obs.csv'
out_path = '/Users/coloury/Dropbox/Documents/QTProjects/S-CCD/test'
probability = 0.95
min_days_conse = 80
